...
{
    public partial class Addiitialodels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChechoutHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChechoutHistories_LibraryAssets_LibraryAssetid",
                        column: x => x.LibraryAssetid,
                        principalTable: "LibraryAssets",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChechoutHistories_LibraryCards_LibraryCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChechoutHistories_LibraryAssetid",
                table: "ChechoutHistories",
                column: "LibraryAssetid");

            migrationBuilder.CreateIndex(
                name: "IX_ChechoutHistories_LibraryCardId",
                table: "ChechoutHistories",
                column: "LibraryCardId");
